...
export const metadata: Metadata = withCanonical({
  title: "前往官方渠道购买",
  description: "蜜女郎官网购买路径说明：官网了解品牌与产品，天猫旗舰店或京东旗舰店提供商品规格、发货、物流与售后说明。"
}, "/buy");
    ...
    <main>
      ...
      <section className="container-shell py-14 md:py-20">
        <SectionHeader
          ...
          description="蜜女郎官网不直接销售商品。购买按钮提供天猫旗舰店与京东旗舰店两个官方渠道，方便你查看真实商品规格、发货、物流与售后规则。"
        />
        <div className="mt-8 grid gap-4 md:grid-cols-4">
          {[
            ...
            ["4", "完成购买", "在天猫或京东官方旗舰店页面确认规格、发货、物流与售后后再决定。"]
          ].map(([step, title, text]) => (
