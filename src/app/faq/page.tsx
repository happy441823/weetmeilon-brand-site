...
export const metadata: Metadata = withCanonical({
  title: "FAQ 常见问题",
  description: "蜜女郎常见问题：品牌官网用途、材质体验、隐私购买、清洁保养、产品选择与官方旗舰店说明。"
}, "/faq");

const fallbackFaqs: PublicFaq[] = [
  ["这是官方品牌站吗？", "是。这里用于介绍蜜女郎品牌、材质体验、产品系列、隐私发货和清洁保养。具体商品购买请前往蜜女郎天猫或京东旗舰店。"],
  ["为什么官网不直接下单？", "官网主要提供品牌和产品信息参考。具体商品规格、发货与售后说明，由天猫或京东官方旗舰店负责。"],
  ...
  ["为什么官网不展示交易动态信息？", "官网主要保留稳定的品牌、材质、清洁和隐私购买说明。具体规格、发货、售后与平台规则，请以官方旗舰店页面为准。"],
    ...
    <main>
      ...
      <section className="container-shell py-14 md:py-20">
        <SectionHeader
          ...
          description="FAQ 不追求制造刺激，而是回答真实问题：品牌身份、材质体验、隐私购买、清洁方式、产品选择与官方旗舰店入口。"
        />
