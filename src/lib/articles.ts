...
const defaultDraftSections: ArticleSection[] = [
  {
    ...
    body: [
      "这篇草稿用于帮助用户在购买前建立判断顺序：先理解材质和产品类型，再确认隐私发货、清洁保养与官方购买渠道。它不替代具体商品页，也不展示动态价格、库存、销量或平台活动信息。",
  ...
  },
  {
    heading: "相关入口建议",
    body: [
      "可在正文中关联产品中心 /products、清洁指南 /guide、隐私发货 /privacy-shipping、FAQ /faq，以及对应分类页面，帮助用户在官网内完成购买前的信息确认。",
      "如果涉及具体商品，只描述公开稳定的信息，并提醒用户进入官方旗舰店确认规格、价格、库存、物流和售后。"
    ]
  },
  {
    heading: "常见问题",
    body: [
      "问：官网为什么不展示实时价格？答：价格、库存和优惠会随平台活动变化，官网不展示不稳定数据，购买前以官方旗舰店实时页面为准。",
  ...
  },
  {
    heading: "审核边界",
    body: [
      "发布前请确认 SEO Title、SEO Description、canonical、相关商品或分类内链已经补齐，并确认正文没有高风险词堆砌、销量付款数据或无法验证的承诺。",
...
export const articles: Article[] = [
  {
    ...
    sections: [
      ...
      },
      {
        ...
        body: [
          "官网不会展示动态价格、库存或平台活动标签。实际购买前，请以天猫或京东官方旗舰店页面为准，确认商品标题、规格、包装清单、清洁方式、发货规则和售后说明。",
  ...
  },
  {
    ...
    outline: ["官网主要提供哪些信息", "官方旗舰店提供哪些购买服务", "价格库存售后为什么以平台为准", "如何选择天猫或京东入口"],
    sections: defaultDraftSections,
    readMinutes: 3,
    status: "draft",
    indexable: false
  ...
  },
  {
    ...
    outline: ["先看规格和材质说明", "确认包装和发货规则", "查看清洁与收纳建议", "价格库存售后以旗舰店为准"],
    sections: defaultDraftSections,
    readMinutes: 4,
    status: "draft",
    indexable: false
