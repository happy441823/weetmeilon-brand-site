...
const updates = [
  ...
  item("tmall-932717912766", "硅胶半身柔感款", "硅胶半身款", "硅胶系列 · 半身轮廓 · 柔感方向", "halfSilicone"),
  item("tmall-1034711994048", "硅胶长腿半身款", "长腿半身款", "硅胶系列 · 半身长腿方向", "halfSilicone"),
  ...
  item("tmall-1003179680764", "硅胶全腿半身款", "全腿半身款", "硅胶系列 · 全腿半身方向", "halfSilicone"),
  item("tmall-1033146604001", "硅胶半身基础款", "硅胶基础款", "硅胶系列 · 半身基础方向", "halfSilicone"),
  item("tmall-1008749329121", "硅胶臀部柔感款", "硅胶臀部款", "硅胶系列 · 臀部轮廓 · 柔感方向", "hipSilicone"),
  item("tmall-978357698377", "硅胶半身细节款", "硅胶细节款", "硅胶系列 · 半身细节方向", "halfSilicone"),
  item("tmall-1037741386848", "硅胶半身典藏款", "硅胶典藏款", "硅胶系列 · 半身典藏方向", "halfSilicone"),
  ...
  item("tmall-1015501179254", "硅胶局部造型款", "硅胶局部款", "硅胶系列 · 局部造型 · 轻量收纳", "localSilicone"),
  item("tmall-1049922662436", "硅胶半身静奢款", "硅胶静奢款", "硅胶系列 · 半身柔感方向", "halfSilicone"),
  ...
  item("tmall-956711010507", "硅胶半身柔弧款", "硅胶柔弧款", "硅胶系列 · 半身柔弧方向", "halfSilicone"),
  item("tmall-1047503838777", "硅胶臀线半身款", "硅胶臀线款", "硅胶系列 · 臀线半身方向", "halfSilicone"),
  item("tmall-1046323454771", "硅胶自动半身款", "硅胶自动款", "硅胶系列 · 自动配置 · 半身方向", "automaticSilicone"),
  item("tmall-935751348502", "便携自动入门款", "便携自动款", "入门系列 · 便携自动 · 官方在售", "automaticFine"),
  item("tmall-839593996256", "硅胶自动臀部款", "硅胶自动臀部", "硅胶系列 · 自动配置 · 臀部轮廓", "automaticSilicone"),
  item("tmall-1026704244735", "高弹硅胶半身款", "高弹硅胶款", "硅胶系列 · 高弹半身方向", "halfSilicone"),
  item("tmall-1037064556812", "细腻纹理自动体验款", "自动体验款", "细腻纹理 · 自动系列 · 官方在售", "automaticFine"),
  item("tmall-966709910145", "硅胶半身精选款", "硅胶精选款", "硅胶系列 · 半身精选方向", "halfSilicone")
];
